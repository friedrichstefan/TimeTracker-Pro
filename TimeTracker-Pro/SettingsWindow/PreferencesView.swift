...
enum PrefsTab: String, CaseIterable, Hashable {
    ...
    var title: String {
        ...
        case .analyse: return "App-Analyse"  // NEU
    ...
    var systemImage: String {
        ...
        case .analyse: return "chart.pie"  // NEU
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                ModernSectionHeader(
                    ...
                    subtitle: "Konfiguration der Uhr-Anzeige und App-Tracking"
                )
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        HStack {
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text("Verfolge verwendete Apps während Arbeitszeit")
                                    .font(.caption)
                                    .foregroundStyle(.secondary)
                            }
